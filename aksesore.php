            ...
            footer
{
    ...
    <body>
        ...
        $start_from=($page-1)*$per_page;
            $merr_produktet="select *from produkte WHERE ID_kategori BETWEEN 9 AND 10
        ...
        <div class="nr-e-faqeve">
            ...
            $query="select * from produkte where ID_kategori BETWEEN 9 AND 10";
                $rez=mysqli_query($con,$query);
                $totali=mysqli_num_rows($rez);
                $total_faqe=ceil($totali / $per_page);
                echo "
                <li>
                <a  style='display:inline; text-decoration:none;'href='aksesore.php?page=1'>".'Faqja e pare'."</a>
                </li>";
                for($i=1;$i<=$total_faqe;$i++){
                    echo " <li>
                    <a style='display:inline; text-decoration:none;'href='aksesore.php?page=".$i."'>".$i."</a>
                    </li>";
                    
                };
                echo "
                <li>
                <a style=' text-decoration:none; href='aksesore.php?page=$total_faqe'>".'Fund'."</a>
                </li>";
