    ...
    <body>
      ...
      <?php  
        ...
        $start_from=($page-1)*$per_page;
            $merr_produktet="select *from produkte order by 1 ASC LIMIT $start_from,$per_page";
            ...
            while($row_produkte=mysqli_fetch_array($produkte)){
                ...
                echo "
                <div style='margin-top:20px;margin-left:20px;width:480px;
                 ' class='col-md-4 col-sm-6 center-responsive'>
    ...
    <center>
        <div class="nr-e-faqeve">
            ...
            $query="select * from produkte";
                ...
                echo "
                <li>
                <a  style='display:inline; text-decoration:none;'href='bli.php?page=1'>".'Faqja e pare'."</a>
                </li>";
                for($i=1;$i<=$total_faqe;$i++){
                    echo " <li>
                    <a style='display:inline; text-decoration:none;'href='bli.php?page=".$i."'>".$i."</a>
                    </li>";
                    
                };
                echo "
                <li>
                <a style=' text-decoration:none; href='bli.php?page=$total_faqe'>".'Fund'."</a>
                </li>";
